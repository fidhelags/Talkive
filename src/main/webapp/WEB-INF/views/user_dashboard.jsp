...
<body class="flex min-h-screen">
    ...
    <aside class="w-72 bg-brand-surface/30 border-r border-white/5 flex flex-col p-6">
        ...
        <div class="pt-6 border-t border-white/5">
            <a href="<c:url value='/auth/logout'/>" class="sidebar-link text-red-400 hover:bg-red-400/10 hover:text-red-400">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center justify-center gap-2">
                                        <span class="text-lg">
                                            <c:choose>
                                                <c:when test="${booking.slot.tutor.language == 'English'}">🇬🇧</c:when>
                                                <c:when test="${booking.slot.tutor.language == 'Indonesia'}">🇮🇩</c:when>
                                                <c:when test="${booking.slot.tutor.language == 'Japanese'}">🇯🇵</c:when>
                                                <c:when test="${booking.slot.tutor.language == 'Korean'}">🇰🇷</c:when>
                                                <c:when test="${booking.slot.tutor.language == 'Chinese'}">🇨🇳</c:when>
                                                <c:otherwise>🌍</c:otherwise>
                                            </c:choose>
                                        </span>
                                        <span class="font-medium text-white">${booking.slot.tutor.language}</span>
                                    </div>
                                </td>
                                <td>
