...
<body class="flex min-h-screen">
    ...
    <aside class="w-72 bg-brand-surface/30 border-r border-white/5 flex flex-col p-6">
        ...
        <nav class="flex-1 space-y-2">
            ...
            <a href="<c:url value='/tutor/profile'/>" class="sidebar-link active">
    ...
    <main class="flex-1 p-10 overflow-y-auto">
        <header class="mb-10">
            ...
            <p class="text-text-gray mt-1 font-medium">Manage your professional tutor identity and credentials</p>
        </header>
        ...
        <section class="max-w-4xl bg-brand-surface rounded-[2.5rem] border border-white/5 p-10 shadow-2xl">
            ...
            <form action="<c:url value='/tutor/profile/update'/>" method="post" class="space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    ...
                    <div class="flex flex-col space-y-2">
                        ...
                        <input type="email" name="email" value="${tutor.email}" required
                            class="form-input rounded-2xl px-5 py-4 text-sm font-medium">
                    </div>

                    <div class="flex flex-col space-y-2">
                        <label class="text-xs font-extrabold text-text-gray uppercase tracking-widest ml-1">STR / License</label>
                        <input type="text" name="certification" value="${tutor.certification}" placeholder="STR Number"
                            class="form-input rounded-2xl px-5 py-4 text-sm font-medium">
                    </div>

                    <div class="flex flex-col space-y-2">
                        <label class="text-xs font-extrabold text-text-gray uppercase tracking-widest ml-1">Years Exp</label>
                        <input type="number" name="yearsExperience" value="${tutor.yearsExperience}" min="0" required
                            class="form-input rounded-2xl px-5 py-4 text-sm font-medium">
                    </div>
                    ...
                    <div class="flex flex-col space-y-2 md:col-span-2">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <!-- Dropdown -->
                            <select name="language" id="editLanguageSelect" required
                                ...
                                <option value="French" ${tutor.language == 'French' ? 'selected' : ''}>🇫🇷 French</option>
                                <option value="German" ${tutor.language == 'German' ? 'selected' : ''}>🇩🇪 German</option>
                                <option value="Spanish" ${tutor.language == 'Spanish' ? 'selected' : ''}>🇪🇸 Spanish</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col space-y-2 md:col-span-2">
                        <div class="flex flex-col space-y-2 md:col-span-2">
                            ...
                            <div class="relative">
                                <input type="password" name="password" id="tutorPassword" placeholder="••••••••"
                                    class="form-input rounded-2xl px-5 py-4 pr-14 text-sm font-medium w-full">
                                <button type="button" onclick="togglePassword('tutorPassword', 'tutorEye')"
                                    class="absolute right-4 top-1/2 -translate-y-1/2 text-text-gray hover:text-brand-orange transition-colors">
                                    <svg id="tutorEye" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div id="deletePopup" class="popup-overlay">
            <div class="bg-brand-surface border border-white/10 p-10 rounded-[2.5rem] max-w-md w-full mx-4 shadow-2xl text-center">
                ...
                <p class="text-text-gray text-sm mb-10 leading-relaxed font-medium">
                    This action is permanent. Deleting your account will remove all your professional tutor profile data and booking history.
                </p>
                <div class="flex flex-col sm:flex-row gap-3">
                    ...
                    <a href="<c:url value='/tutor/profile/delete'/>" 
